  ...
  <header id="header" class="fixed-top">
    <div class="container">
      ...
      <div class="logo float-left">
        ...
        <a href="index.php" class="scrollto"><img src="img/logo.png" alt="" class="img-fluid lgstle"></a>
      </div>
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="business-intelligence.php">Business Intelligence Services</a></li>
